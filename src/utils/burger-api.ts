...
// запросить все доступные ингредиенты
...
// запросить все оформленные заказы без ключа
...
// запросить все оформленные заказы с ключом авторизации
